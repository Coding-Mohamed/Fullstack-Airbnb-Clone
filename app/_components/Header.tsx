...
const Header: React.FC = () => {
  return (
    <header className="md:sticky md:top-0 fixed w-full bottom-0 bg-[#DE8022] text-white z-[999]">
      {/* Top Navigation */}
      <div className="flex justify-between items-center p-4 ">
        ...
        <nav className="flex space-x-6 ml-4">
          <Link href="/" className="flex flex-col md:flex-row items-center space-y-1 md:space-y-0 md:space-x-2 hover:text-[#FFF2E5] transition duration-200">
            <TbZoom size={24} />
            <span>Packages</span>
          </Link>
          <Link href="/houses" className="flex flex-col md:flex-row items-center space-y-1 md:space-y-0 md:space-x-2 hover:text-[#FFF2E5] transition duration-200">
            <GiHouse size={24} />
            <span>Houses</span>
          </Link>
